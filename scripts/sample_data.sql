...
INSERT INTO copias(mid, numero) VALUES ((SELECT max(mid) FROM materiales), 1);
INSERT INTO copias(mid, numero) VALUES ((SELECT max(mid) FROM materiales), 2);
INSERT INTO copias(mid, numero) VALUES ((SELECT max(mid) FROM materiales), 3);
INSERT INTO copias(mid, numero) VALUES ((SELECT max(mid) FROM materiales), 4);
INSERT INTO copias(mid, numero) VALUES ((SELECT max(mid) FROM materiales), 5);
INSERT INTO copias(mid, numero) VALUES ((SELECT max(mid) FROM materiales), 6);
INSERT INTO copias(mid, numero) VALUES ((SELECT max(mid) FROM materiales), 7);
...
INSERT INTO copias(mid, numero) VALUES ((SELECT max(mid) FROM materiales), 6);
INSERT INTO copias(mid, numero) VALUES ((SELECT max(mid) FROM materiales), 7);
INSERT INTO copias(mid, numero) VALUES ((SELECT max(mid) FROM materiales), 8);
INSERT INTO copias(mid, numero) VALUES ((SELECT max(mid) FROM materiales), 9);
INSERT INTO copias(mid, numero) VALUES ((SELECT max(mid) FROM materiales), 10);
...
INSERT INTO copias(mid, numero) VALUES ((SELECT max(mid) FROM materiales), 9);
INSERT INTO copias(mid, numero) VALUES ((SELECT max(mid) FROM materiales), 10);
INSERT INTO copias(mid, numero) VALUES ((SELECT max(mid) FROM materiales), 11);
INSERT INTO copias(mid, numero) VALUES ((SELECT max(mid) FROM materiales), 12);
INSERT INTO copias(mid, numero) VALUES ((SELECT max(mid) FROM materiales), 13);
INSERT INTO copias(mid, numero) VALUES ((SELECT max(mid) FROM materiales), 14);
INSERT INTO copias(mid, numero) VALUES ((SELECT max(mid) FROM materiales), 15);
